...
// Fetching list of doctors by specialty
export const FETCH_DOCTORS_BY_SPECIALTY_REQUEST = 'FETCH_DOCTORS_BY_SPECIALTY_REQUEST';
export const FETCH_DOCTORS_BY_SPECIALTY_SUCCESS = 'FETCH_DOCTORS_BY_SPECIALTY_SUCCESS';
export const FETCH_DOCTORS_BY_SPECIALTY_FAILURE = 'FETCH_DOCTORS_BY_SPECIALTY_FAILURE';
...
// Fetching list of patient's visits
...
// Fetching list of doctor's visits
export const FETCH_DOCTOR_VISITS_REQUEST = 'FETCH_DOCTOR_VISITS_REQUEST';
export const FETCH_DOCTOR_VISITS_SUCCESS = 'FETCH_DOCTOR_VISITS_SUCCESS';
export const FETCH_DOCTOR_VISITS_FAILURE = 'FETCH_DOCTOR_VISITS_FAILURE';

// Fetching list of visits for visit scheduler
export const FETCH_SCHEDULER_VISITS_REQUEST = 'FETCH_SCHEDULER_VISITS_REQUEST';
export const FETCH_SCHEDULER_VISITS_SUCCESS = 'FETCH_SCHEDULER_VISITS_SUCCESS';
export const FETCH_SCHEDULER_VISITS_FAILURE = 'FETCH_SCHEDULER_VISITS_FAILURE';
