...
class DoctorAddForm extends React.Component {
	...
	render() {
		...
		return (
			<React.Fragment>
				<h3 className="doctor-add-form-title">Add new doctor</h3>
				<Formik
					...
					{({ errors, touched, isSubmitting }) => (
						<Form className="form">
							...
							<div className={'form-row' + (errors.specialty && touched.specialty ? ' error' : '')}>
								<label htmlFor="specialty">Doctor's specialty*</label>
								<Field id="specialty" name="specialty" as="select">
